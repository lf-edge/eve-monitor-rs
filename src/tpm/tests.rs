...
//         tcg_tpmlog::{Digest, TcgRawTpmEvent, TcgTpmEventType, TcgTpmLog},
//         tpmlog::TpmEvent,
//     },
// };
...
// fn moc_pcr14_event(file: &str, exists: bool, hash: Option<&str>) -> TcgRawTpmEvent {
...
//     let log = TcgTpmLog::from_slice(&data).unwrap();
//     println!();
...
//     let old_good_log = EveTpmLog::from_events(TcgTpmLog::from_slice(&old_good_bin).unwrap().events);
//     let new_log = EveTpmLog::from_events(TcgTpmLog::from_slice(&new_bin).unwrap().events);
